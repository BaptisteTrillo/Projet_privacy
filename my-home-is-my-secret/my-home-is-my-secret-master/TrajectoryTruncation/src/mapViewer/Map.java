...
public class Map extends JComponent implements MouseListener, MouseMotionListener {
    ...
    /**
     * The transformation that is used to transform map coordinates to image coordinates.
     */
    ...
    public Map(MapFrame m) {
        ...
        addComponentListener(new ComponentAdapter(){public void componentResized(ComponentEvent evt) {
            if(autoFitToDisplay) fitMapToDisplay();}});
    ...
    /**
     * Defines whether the map content is automatically scaled to 
     * fit this display frame when its size is changed.
    ...
    /**
     * Fits a part of the map to the current extent of the display, 
     * specified by the part's coordinate bounds.
    ...
    public void mouseClicked(MouseEvent e) {
       ...
       if (e.getButton() == MouseEvent.BUTTON1) { 
         ...
         // TODO Als Hausaufgabe (1.c) zur Auswahl der Polygone erweitern
        }
